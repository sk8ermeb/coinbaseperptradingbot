...
I am now using this for my live algorithms. I will still make lots of changes. Obviously for educational purposes only/use at your own risk. 
## Description
A Web based tool to build trading algorihtms for Coinbase US perpetual futures advanced trade API. Has complete back testing capability. Should be a close approximation for live testing but of course bugs can happen and nuaonces around real time market data versus candles will always differ. There are a lot of detailed complications for US traders around the contracts. The system will extrapolate the current available contracts and then will back test against the equivilent INT product id Complete documentation:
...
<img alt="Screenshot 2026-05-18 at 11 44 40 PM" src="https://github.com/user-attachments/assets/28191d43-5252-4a01-98f8-65273b98830d" />
## BackTesting
...
<img alt="Live Trading Screen" src="https://github.com/user-attachments/assets/5a62a86f-365f-45e9-8e8c-14b9cd7892de" />
